...
export default class Profile extends Component {
  ...
  render() {
    const { name, email, joinDate, totalSessions, totalData } = this.state;
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ paddingHorizontal: 20, marginBottom: 12 }}>
            ...
            <View style={styles.card}>
              {this.renderInfoRow('Plan', PLAN_DATA.name)}
              <View style={styles.divider} />
              {this.renderInfoRow('Expires', PLAN_DATA.expires)}
              <View style={styles.divider} />
              {this.renderInfoRow('Bandwidth', PLAN_DATA.bandwidth)}
              <View style={styles.divider} />
              <View style={styles.infoRow}>
          ...
          <View style={{ paddingHorizontal: 20, marginBottom: 30 }}>
            ...
            <View style={styles.card}>
              ...
              <View style={styles.divider} />
              <TouchableOpacity style={styles.actionRow} onPress={() => this.handleLogout()}>
